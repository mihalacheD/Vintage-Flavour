...
const categories: {label: string, id: string, imageUrl: string}[]=[
  ...
  {label: "Salad", id: "Salad", imageUrl: "https://www.inspiredtaste.net/wp-content/uploads/2020/07/Bean-Salad-Recipe-2-1200.jpg"},
...
const Categories = () => {
  ...
  return (
    <Grid gap='3' my='9' mx='4' columns={{ initial: "3", md: "9" }}>
      ...
      <Box key={category.id} style={{ border: 'none'}} onClick={() => handleCategoryClick(category)}>
          <Flex gap='3' direction='column' align='center'>
           ...
           <Box>
            <Text as="div" size="2" weight="bold" color='gray'>{category.label}</Text>
           </Box>
           </Flex>
      </Box>
      ))}
